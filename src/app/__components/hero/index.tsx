			...
			<div className="relative z-10">
				...
				<div className="flex flex-row space-x-4 h-full items-baseline">
					...
					<a
						...
						className="transition-[background-color,scale] duration-200 hover:scale-105 bg-gray-400 hover:bg-gray-500 text-white font-bold py-2 px-4 rounded flex justify-center w-full h-auto sm:w-auto text-sm sm:text-base"
						rel="noreferrer"
					>
						My Resume
					</a>
