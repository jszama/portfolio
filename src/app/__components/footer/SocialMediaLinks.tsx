...
function SocialMediaLink({ href, icon }: { href: string; icon: React.ReactNode }) {
    return (
        <a href={href} target="_blank" rel="noopener noreferrer" className="text-[var(--accent-text)] hover:text-[var(--primary-magenta)] transition duration-300 hover:scale-110">
            {icon}
        </a>
    )
}