				...
				>
					...
					{isExpanded && (
						<div className="border-l-3 border-[var(--secondary-dark-background)] h-full w-full overflow-hidden px-3 text-[0.625rem] sm:text-sm text-[var(--primary-text)] pt-2 text-start font-normal relative">
							...
							{readMore && (
								<Button
									className="absolute cursor-pointer bottom-2 right-2 text-[var(--primary-text)] font-bold hover:text-[var(--hover-magenta)] transition-[color] duration-300 ease-in-out"
									onClick={() => toggleModal()}
								>
									Read more
								</Button>
