...
import { ProjectType } from './assets/ProjectTypes';
      ...
      <>
        <article className="pt-2 px-2">
          ...
          <span className='flex flex-col justify-between items-start w-full px-1'>
            <p className="pt-1 text-lg text-[var(--heading-text)] mb-1">{props.project.name} <span className='text-xs text-gray-400'>- {props.project.shortDescription}</span></p>
